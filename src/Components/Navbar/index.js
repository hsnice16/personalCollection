        ...
        <nav>
            <div className="nav-div">
                <div className="n-d-1">
                    {
                        auth.currentUser 
                        ?
                        <Link to={ROUTES.HOME}><span>p</span>ersonal<span>C</span>ollection</Link>
                        :
                ...
                <div className="n-d-2">
                    ...
                    {[ROUTES.LANDING, ROUTES.CREATE_ACCOUNT].includes(location.pathname)
                        && 
                        <Link to={ROUTES.CREATE_ACCOUNT} className="n-d-2-link-2">Create Account</Link>}
                    {[ROUTES.HOME, ROUTES.VIDEOS, ROUTES.PHOTOS].includes(location.pathname)
                        && 
                        <>
